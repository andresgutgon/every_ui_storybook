defmodule EveryUiPlaygroundWeb.Router do
  ...
  # scope "/api", EveryUiPlaygroundWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:every_ui_playground, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: EveryUiPlaygroundWeb.Telemetry
